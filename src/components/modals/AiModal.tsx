              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#b60575] focus:ring-opacity-50 focus:border-transparent text-base text-gray-900 placeholder-gray-500 min-h-[100px] shadow-sm transition-all bg-white hover:bg-gray-50 focus:bg-white"
                  />
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    ...
                    className="flex-1 bg-[#b60575] text-white px-6 py-3 rounded-xl hover:bg-pink-700 transition-all disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg shadow-pink-200/50 disabled:shadow-none"
                  >
                    {isRecommending ? (
                      <>
                  ...
                  <button
                    ...
                    className="px-6 py-3 border-2 border-[#b60575] text-[#b60575] rounded-xl hover:bg-pink-50 transition-all disabled:opacity-50 flex items-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {recommendation && (
              <div className="p-6 bg-gradient-to-b from-pink-50/80 to-white">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-[#b60575] flex items-center justify-center text-white">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="text-[#b60575] font-semibold whitespace-nowrap text-lg">
                  ...
                  <div className="mt-6 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-2xl font-semibold text-[#b60575]">
                          {(
