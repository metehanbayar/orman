        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="p-3 pt-1 mt-auto">
            {product.variations?.length ? (
              <span className="block w-full px-2 py-1 bg-[#EE9621] text-white text-xs font-medium rounded-lg text-center">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-start">
                      ...
                      {!currentProduct.variations?.length && (
                        <span className="text-xl font-bold text-[#EE9621]">
                        ...
                        <div className="grid gap-2">
                          {currentProduct.variations.map((variation) => (
                            ...
                            >
                              ...
                              <span className="text-lg font-bold text-[#EE9621]">{variation.price} ₺</span>
                            </div>
                          ))}
                        </div>
                      </div>
