...
export default function HomePage() {
  ...
  if (showSplash) {
    return (
      <div className="fixed inset-0 overflow-hidden bg-gradient-to-br from-[#EE9621] via-[#4C4B1F] to-white">
        {/* Arka plan efektleri - Optimize edilmiş */}
        <div className="absolute inset-0">
          {/* Ana gradyan daireler - Daha az blur ve opacity */}
          <div className="absolute top-1/4 left-1/4 w-[300px] h-[300px] bg-gradient-to-r from-[#EE9621] to-[#4C4B1F] rounded-full blur-2xl opacity-20 animate-spin-slow" />
          <div className="absolute bottom-1/4 right-1/4 w-[250px] h-[250px] bg-gradient-to-l from-[#EE9621] to-[#4C4B1F] rounded-full blur-2xl opacity-15 animate-spin-reverse-slow" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center h-16 px-4 border-b border-pink-100">
            ...
            <nav className="flex items-center gap-3">
              <Link
                href="/favorites"
                className="px-4 py-2 text-sm rounded-xl bg-white text-[#EE9621] border border-[#4C4B1F] hover:bg-[#4C4B1F]/10 transition-colors flex items-center gap-2"
              >
              ...
              <button
                ...
                className="px-4 py-2 text-sm rounded-xl bg-[#EE9621] text-white hover:bg-[#4C4B1F] transition-colors flex items-center gap-2 shadow-lg shadow-[#4C4B1F]/20"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="p-2 text-[#EE9621] hover:bg-pink-50 rounded-xl transition-colors"
              >
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md z-40 border-t border-pink-100">
        <div className="max-w-7xl mx-auto">
          <div className="relative py-2">
            {/* Başlık */}
            <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-[#EE9621] text-white px-4 py-1.5 rounded-full shadow-lg shadow-pink-500/20 flex items-center gap-1.5 text-sm">
                ...
                >
                  ...
                  {products.filter(p => p.features.some(f => f.value === 'En Çok Satan')).map((product, index) => (
                    ...
                    >
                      ...
                      >
                        <div className="bg-gradient-to-br from-pink-50 to-white p-2.5 rounded-xl border border-pink-100 hover:border-[#EE9621] transition-all">
                          <div className="flex items-center gap-2.5 min-w-[200px]">
                            ...
                            <div className="flex-1 min-w-0">
                              <h3 className="text-sm font-medium text-gray-900 group-hover:text-[#EE9621] transition-colors whitespace-normal line-clamp-2">
                                {product.name}
                              </h3>
                              <p className="text-xs text-[#EE9621] font-medium mt-0.5">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-all ${
                  selectedCategory === category
                    ? 'bg-[#EE9621] text-white shadow-md shadow-pink-200/20'
                    : 'text-gray-600 hover:text-[#EE9621] hover:bg-pink-50'
                }`}
              >
                {category}
              </button>
          ...
          <div className="space-y-12">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center py-12">
                <div className="w-16 h-16 border-4 border-pink-200 border-t-[#EE9621] rounded-full animate-spin"></div>
                <p className="mt-4 text-[#EE9621] font-medium">Menü yükleniyor...</p>
              </div>
            ) : error ? (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-[#EE9621] text-white rounded-xl hover:bg-pink-700 transition-colors shadow-lg shadow-pink-200/20"
                >
                  Tekrar Dene
                </button>
              </div>
                ...
                >
                  <div className="p-6 border-b border-pink-100">
                    <div className="flex items-center justify-between">
                      <h2 className="text-2xl font-bold text-[#EE9621]">
                        {category}
                      </h2>
                      <span className="px-3 py-1 bg-pink-50 text-[#EE9621] text-sm font-medium rounded-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid gap-12 md:grid-cols-3">
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-[#EE9621]">İletişim</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-[#EE9621]">Çalışma Saatleri</h3>
              <p className="text-gray-600">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-[#EE9621]">Sosyal Medya</h3>
              <div className="flex gap-4">
                <a href="#" className="text-gray-400 hover:text-[#EE9621] transition-colors">
